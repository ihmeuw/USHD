// see fit_mod_state_model49.R for model description
...
Type objective_function<Type>::operator() () {
  ...
  DATA_SCALAR(rho_mean);
  DATA_SCALAR(rho_variance);
  
  PARALLEL_REGION nll -= dnorm(logit_rho_1t, rho_mean, rho_variance, true);
  PARALLEL_REGION nll -= dnorm(logit_rho_1a, rho_mean, rho_variance, true);
