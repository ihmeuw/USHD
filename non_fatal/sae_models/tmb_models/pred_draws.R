...
if (race_together) {
  ...
  if (by_sex) {
    # read in the model
    out <- readRDS(paste0(output_dir, "/model_fit_", sex, "_", race, ".rds"))
  } else {
    # read in the model
    out <- readRDS(paste0(output_dir, "/model_fit_0.rds"))
  }
...
# Generate draws -------------------------------------------------------------------------------
if ((by_sex & resub & file.exists(paste0(output_dir_draws_est, "/fe_sims_", sex, "_", race, ".rds")) &
     file.exists(paste0(output_dir_draws_est, "/initial_sims_", sex, "_", race, ".rds")) &
     file.exists(paste0(output_dir_draws_est, "/mean_", sex,"_", race, ".rds"))) |
    (!by_sex & resub & file.exists(paste0(output_dir_draws_est, "/fe_sims_", race, ".rds")) &
     file.exists(paste0(output_dir_draws_est, "/initial_sims_", race, ".rds")) & file.exists(paste0(output_dir_draws_est, "/mean_", race, ".rds")))) {
  ...
  if (by_sex) {
    saveRDS(stratpop, paste0(output_dir_draws_est, "/stratpop_", sex, "_", race, "_", edu, ".rds"))
  } else {
    saveRDS(stratpop, paste0(output_dir_draws_est, "/stratpop_", race, "_", edu, ".rds"))
  }
} 

if (by_sex) {
  saveRDS(sims, paste0(output_dir_draws_est, "/initial_sims_", sex, "_", race, "_", edu, ".rds"))
  saveRDS(mean, paste0(output_dir_draws_est, "/mean_", sex, "_", race, "_", edu, ".rds"))
} else {
  saveRDS(sims, paste0(output_dir_draws_est, "/initial_sims_", race, "_", edu, ".rds"))
  saveRDS(mean, paste0(output_dir_draws_est, "/mean_", race, "_", edu, ".rds"))
}
