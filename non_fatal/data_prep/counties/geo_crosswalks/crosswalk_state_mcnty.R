...
# ######## 4. Upload output metadata
mcnty_mapping_crosswalk_id <- save_mcnty_mapping_crosswalk(
  mcnty_mapping_type_id = 3,
  covariate_dataset_id = 167,
  mcnty_mapping_filepath = paste0(output_dir, "mcnty_state_agg_wts.rds"),
  is_best = FALSE
)

# to make best:
# update_mcnty_mapping_crosswalk(
#   best_status = 1,
#   mcnty_mapping_crosswalk_id = mcnty_mapping_crosswalk_id,
#   prev_issues = "UPDATEME"
# )
