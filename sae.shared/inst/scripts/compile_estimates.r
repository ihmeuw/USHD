...
if (interactive()) {
  ...
  run_lt <- TRUE
  validate <- FALSE
  write_estimates_with_issues <- TRUE
...
check <- function(est, var, eval_vars, settings) {
  ...
  # checFILEPATH all value estimates are >= 0
  ...
  # checFILEPATH there are no duplicates
  ...
  # checFILEPATH all expected level/area/year/sex/race/edu/age combinations are present
  ...
  # checFILEPATH value for both sexes combined is between value for males and females
...
if (run_lt) {
  ...
  if (!validate) {
    ...
    # checFILEPATH all mx/ex estimates are positive
    ...
    # checFILEPATH all qx values are between 0 and 1
    ...
    # checFILEPATH all ax values are between 0 and n
    ...
    # checFILEPATH point estimates within confidence intervals
    ...
    # checFILEPATH all expected level/area/year/sex/age combinations are present
    if("adjusted" %in% names(est)) {
      all <-
        CJ(
          level = c(settings$area_var, names(settings$geoagg_files)),
    ...
    # checFILEPATH mx for both sexes combined is between mx for males and females (allow some tolerance for
