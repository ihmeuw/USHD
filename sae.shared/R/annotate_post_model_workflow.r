...
#' specific details.  Also used by check_raked_result.r, submit_all_aggregation.r, yld_launch_aggregation.r.
#'
...
annotate_post_model_workflow <- function(cause_tree) {
  ...
  # "path_to_top_parent" is usually a string of cause IDs, separated by commas. E.g., "294,295,344".
  for (i in 1:nrow(cause_tree)){ # Lists don't do too well in data.table
