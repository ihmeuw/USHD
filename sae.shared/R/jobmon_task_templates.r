...
#'
#' @description Compiles the jobmon task templates. Written by INDIVIDUAL_NAME Collision
#'
...
#'
#' @note PYTHONPATH= needs to be prepended to commands currently to get things
#' to work on slurm.  SciComp is working on it - slack thread here:
#'
#' @export
load_jobmon_task_templates <- function(jobmon_tool) {
  ...
  # INDIVIDUAL_NAME test: need to rake within a county-level model across causes
