...
ModelSettings <- R6::R6Class(
  ...
  public = list(
    ...
    #' @field LU_folder [string] Limited use directory
    LU_folder = "",
    ...
    #' @description Copies J: drive files listed on settings to dir/from_J_drive, updates the relative path in settings and returns it.
    ...
    get_updated_settings_on_copy_J_dependencies = function() {
      ...
      get_new_path_on_copy_file <- function(file_path, metadata) {
        ...
        # NEVER copy file from limited_use dir
...
GBDSettings <- R6::R6Class(
  ...
  public = list(
    ...
    process_gbd_draws = function(raw.upper.draws, acause, year, sex, measure, population, raked, age) {
      ...
      # for ab, return as-is. The calling script specifies which space to get GBD draws for.
