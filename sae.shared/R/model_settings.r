...
ModelSettings <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description Copies 'FILEPATH' files listed on settings to 'FILEPATH', updates the relative path in settings and returns it.
    ...
    get_updated_settings_on_copy_J_dependencies = function() {
      ...
      metadata <- list()
      metadata <- append(metadata, paste0("Copying files started at: ", Sys.time()))
