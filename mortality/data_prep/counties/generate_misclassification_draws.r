####################################################################################################
## Description: Preps draws of misclassification ratios from Arias et al. 2016. Reads in the ratios
##              and standard errors that have been manually extracted, as well as some other
##              necessary files (e.g., which counties have "high coethnic concentration").
##
## Requires:    Extracted ratios/standard errors from the Arias et al. paper
##
...
# use an example directory to get the desired ages via get_settings()
dir <- "FILEPATH"
get_settings(dir)
n.sims <- 1000
plot <- F  # indicate whether vetting plots are desired
...
# then merge on the ratios by region
...
# prepare for reading in within the pipeline
