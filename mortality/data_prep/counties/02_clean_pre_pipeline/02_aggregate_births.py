...
output: births data compressed to the format of births by year, county,
...
for year in yearvals:
    ...
    square_data.to_csv("FILEPATH", index=False)  # archived version
    square_data.to_csv("FILEPATH", index=False)
