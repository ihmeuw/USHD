...
TMB::compile("tmb_models/mod_spline_iid_race_all_one_variance.cpp")

dyn.load(dynlib("tmb_models/mod_spline_iid_race_all_one_variance"))
config(tape.parallel = 0, DLL = "mod_spline_iid_race_all_one_variance")

# make objective function
cat("\n\n***** Make objective function\n"); flush.console()
obj <- MakeADFun(tmb_data, tmb_par, random = c("B", paste0("re", 1:3)), DLL = "mod_spline_iid_race_all_one_variance", map = map)
