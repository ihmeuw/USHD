...
from cod_prep.utils.upload_a_regression import RegressionUploader
...
def upload(new):
	reg_up = RegressionUplaoder(new, 2428, "Update to Southern SSA proportions",
...
if __name__ == "__main__":
	zaf_mod = zafRtiRegressionModifier(2677, "2018_05_05_south_africa_hiv_cell")
