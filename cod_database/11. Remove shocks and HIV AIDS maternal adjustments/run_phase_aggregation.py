...
def run_phase(df, cause_set_version_id, location_set_version_id,
              ...
              project_id, remove_decimal, code_map_version_id, iso3):
    ...
    code_system_id = int(get_value_from_nid(nid, 'code_system_id', project_id=project_id,
    ...
    disagg_df = get_claude_data("disaggregation", nid, extract_type_id, project_id=project_id)
    misdc_df = get_claude_data("misdiagnosiscorrection", nid, extract_type_id, project_id=project_id)
...
def main(nid, extract_type_id, project_id, remove_decimal, code_map_version_id,
         launch_set_id):
    print_log_message("Reading corrections data")
    df = get_claude_data(
        'corrections', nid=nid, extract_type_id=extract_type_id, project_id=project_id,
    )
...
if __name__ == "__main__":
    ...
    launch_set_id = int(sys.argv[6])
    main(nid, extract_type_id, project_id, remove_decimal, code_map_version_id,
         launch_set_id)
