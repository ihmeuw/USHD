...
setcolorder(data, c("mcnty", "year", "race_1977_id", "race_1977_label", "poverty"))
...
prepped_cov_id <- save_prepped_covariate(path = paste0(out_dir, date_time_stamp, ".rds"),
                                         description = "Poverty rate by race/ethnicity",
                                         prev_issues = "None",
...
make_maps_and_plots(plot_data = data, var = "poverty", geo_var = "mcnty", parent_dir = cov_dir, by_race = T,
                    ...
                    ylim = c(0, 1), yformat = "decimal1", make_maps = F, make_line_plots = F)
